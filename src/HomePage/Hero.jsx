...
const Hero = () => {
  ...
  return (
    <section className='w-screen h-[70vh] md:h-screen text-white  relative mt-15 xl:mt-0  '>
     ...
     <button onClick={() => navigate("/login")} className='bg-blue-700 font-bold px-3 xl:px-8 py-1 xl:py-3 text-lg xl:text-2xl hover:bg-blue-800 cursor-pointer'>Act Now</button>
