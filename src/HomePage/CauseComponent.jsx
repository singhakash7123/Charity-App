...
const CauseComponent = ({heading,donated,percentage,goal,image,progress,description}) => {
 const[favourite,setFavourite] = useState(false)
  ...
  currency: 'INR'
      ...
      <p className='mt-6 text-gray-500 font-normal  text-lg'>{description}</p>
     <div className='flex items-center justify-between mt-6 w-full' >
                ...
                <button onClick={()=>{setFavourite(!favourite)}} className={`text-xl ${favourite?'text-red-500':'text-black'}`} >{
